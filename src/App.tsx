...
function App() {
  ...
  const testimonials = [
    {
      ...
      author: "Марина К., Корпоративное мероприятие",
      rating: 5
    },
    {
  ...
  const gallery = [
    "https://i.ibb.co/tPxNYyS5/photo-2025-02-14-20-22-41.jpg",
    "https://i.ibb.co/4wjM8YBj/photo-2025-01-13-12-27-53.jpg",
    "https://i.ibb.co/5X45XSjf/photo-2025-01-13-12-27-55.jpg",
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://i.ibb.co/xq7Pnmmr/cgjh-7284.jpg"
        ...
        <img 
          ...
          alt="" 
          className="absolute top-20 left-20 w-48 h-48 object-contain opacity-100 animate-float"
        />
        <img 
          src="https://i.ibb.co/wrZxMDfp/6871736-Photoroom-3.png" 
          alt="" 
          className="absolute bottom-20 right-20 w-64 h-64 object-contain opacity-40 animate-float-delayed"
        />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <br></br>
          {/* Promo Video Button */}
          <a href="https://www.youtube.com/@sunrise_wizard" target="_blank" rel="noopener noreferrer" className="group relative inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 px-8 py-4 rounded-full text-xl transition-colors">
          ...
          <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2">
            <div className="flex gap-8 items-center">
              <a href="https://www.youtube.com/@sunrise_wizard" className="text-white/80 hover:text-purple-400 transition-colors">
                <Youtube className="w-8 h-8" />
              </a>
              <a href="http://instagram.com/sunrise__wizard" className="text-white/80 hover:text-purple-400 transition-colors">
                <Instagram className="w-8 h-8" />
              </a>
              {/* <a href="https://vk.com/sunrise__wizard" className="text-white/80 hover:text-purple-400 transition-colors">
              ...
              <a href="https://www.tiktok.com/@sunrise__wizard?lang=ru-RU" className="text-white/80 hover:text-purple-400 transition-colors">
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
                </svg>
              </a>
              <a href="https://t.me/sunrise_wizard" className="text-white/80 hover:text-purple-400 transition-colors">
      ...
      <section className="py-24 relative overflow-hidden">
        <img 
          ...
          alt="" 
          className="absolute top-0 left-0 w-72 h-72 object-contain opacity-40 animate-float-slow"
        />
      ...
      <section className="py-24 bg-purple-900/20 relative">
        <img 
          ...
          alt="" 
          className="absolute bottom-0 right-0 w-80 h-80 object-contain opacity-100 animate-float-reverse"
        />
      ...
      <section className="py-24 relative overflow-hidden">
        <img 
          ...
          alt="" 
          className="absolute top-0 right-0 w-64 h-64 object-contain opacity-50 animate-float-slow"
        />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-purple-900/30 backdrop-blur-sm p-8 rounded-lg border border-purple-500/20">
              ...
              Я Макс Треф – иллюзионист с более чем 7-летним опытом. Могу гарантировать, что моя магия преобразит любое событие, наполнив его неповторимой атмосферой и яркими впечатлениями.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
              Мои выступления – это захватывающие иллюзии, интригующие трюки и незабываемые эмоции. Я сочетая комедийный элемент с качественной магией, оставляя публику в восторге и ожидании.
      ...
      <section className="py-24 bg-purple-900/20 relative">
        <img 
          ...
          alt="" 
          className="absolute bottom-0 left-0 w-72 h-72 object-contain opacity-50 animate-float"
        />
      ...
      <footer className="py-8 text-center text-gray-400">
        <p> WhatsApp: +7 (981) 776 26 16</p>        
        <p>© {new Date().getFullYear()} Макс Треф</p>
      </footer>
    </div>
  );
}
